...
const LoginDark: React.FC = () => {
    ...
    return (
        ...
        <div className="w-3/5 bg-gray-800 p-10 flex flex-col justify-center rounded-l-[50px] shadow-md">
            ...
            <label className="text-sm text-white">Enter your company email*</label>
            <input type="email" placeholder="Email" className="border p-3 rounded-md" required />
                        
                        <label className = "text-sm text-white">Enter your password*</label>
                        <div className = "relative">
                        <input type = {showPassword ? "text": "password"} placeholder = "Password" className = "border p-3 w-full rounded-md" required/>
                        ...
                        <label className = "flex items-center space-x-2 text-gray-500"><input type = "checkbox" /> 
                            <span>Keep me logged in</span>
                        </label>

                        <button type="submit" className="bg-blue-600 text-white p-3 rounded-full font-bold hover:bg-blue-700"> Log in </button>
